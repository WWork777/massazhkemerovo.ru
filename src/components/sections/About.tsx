        ...
        <div className={styles.wrap}>
          <div className={styles.text}>
            <p className={styles.text_m2}>
              В &quot;Эфириуме&quot; вы найдёте убежище от стресса и суеты. Наши
              мастера помогут вам восстановить силы, обрести внутреннее
              спокойствие и испытать истинное наслаждение от прикосновений.
            </p>
            <p className={styles.text_m2}>
